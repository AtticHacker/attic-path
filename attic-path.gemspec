...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Attic Path is a gem that gives you more options for gets.chomp. With Attic Path you can browse your system while being in the gets.chomp. The user can select files and add them to an array."
